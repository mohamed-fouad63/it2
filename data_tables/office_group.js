    ...
    function (data) {
      $.each(data, function (key, val) {
        ...
        tablekey = $("#" + key).DataTable({
          ...
          bProcessing: true,
          ajax: {
            url: "/it2/api/office/office_group2.php",
            method: "post",
            data: function (d) {
          ...
          columns: [
            ...
            { data: "address" },
            {
              ...
              render: function (data, type, row) {
                ...
                <a class="btn" id="print_dvices" target="blank" tabindex="0" data-placement="right" title="طباعه جرد المكتب" href="../../it2/grd/?office_name=${row.office_name}">
