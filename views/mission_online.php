...
<body>
    ...
    <script src="../data_tables/mission_online.js"></script>
    <script src="../js/mission_online/add_mission.js"></script>
    <script src="../js/mission_online//remove_mission.js"></script>
