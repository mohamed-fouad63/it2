            ...
            <form action="" method="post">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control me-3" name="it_name" id="it_name" placeholder="القائم بالماوريه"
                            readonly>
                        <span class="input-group-text col-sm-2" id="select_office_name_label">مكتب المرور</span>
                        <select class="form-select form-control" id="select_office_name" name="office_name"
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="date" class="form-control me-3" id="mission_date_start" name="misin_date"
                            value="<?php echo date('Y-m-d') ?>">
                        <span class="input-group-text col-sm-2" id="mission_date_end_label">حتى تاريخ</span>
                        <input type="date" class="form-control" id="mission_date_end"
                            value="<?php echo date('Y-m-d') ?>">
                ...
                <div class="modal-footer">
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="checkbox" value="" id="chk_btn"
                            onclick="dismiss_modal_check('chk_btn','add_mission_btn')">
                    </div>
                    <div id="vaction_div" class="flex-grow-1">
                        <button type="hidden" class="btn btn-primary" formaction="vaction_form_sub.php"
                            formtarget="_blank">
                    ...
                    <button type="button" class="btn btn-success add_mission" id="add_mission_btn"
