            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control list" name="office_name" id="office_name"
                                        onchange="chanemisin()" required>
                                        <option></option>
                                        <option value="اجازه اعتياديه">اجازه اعتياديه</option>
                                        <option value="اجازه عارضه">اجازه عارضه</option>
                                        <?php
                                            //$sql10 = "SELECT office_name FROM all1 where id_it like '$session_id' ORDER BY office_name ASC";
                                            $sql10 = "SELECT office_name FROM all1  ORDER BY office_name ASC";
                                            $result10 = $conn->query($sql10);
                                            while($row10 = $result10->fetch_assoc()) {?>
                                        <option value="<?php echo $row10['office_name'] ?>">
                                            <?php echo $row10['office_name'] ?>
                                        </option>
                                        <?php }?>
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control list" name="it_name" id="it_name"
                                        value="<?php echo $_SESSION['user_name']?>" placeholder="it_name" required>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4" id="toggle_badal_raha">
                                    <input type="date" class="form-control list" id="badal_raha_date" name="badal_raha_date"
                                        placeholder="تاريخ بدل الرحه">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="date" class="form-control list" id="misin_date" name="misin_date" value="<?php echo date('Y-m-d') ?>"
                                        placeholder="تاريخ الماموريه" required>
                                </div>
                            ...
                            <div class="form-group" id="misin_time">
                                ...
                                <script>document.getElementById("end_time").value = "15:00:00";</script>
                                <label class="control-label col-sm-2">الى الساعه</label>
                                <div class="col-sm-4">
                                    <input type="time" class="form-control list" id="start_time" name="start_time"
                                        required>
                                </div>
                                <script>document.getElementById("start_time").value = "08:00:00";</script>
                            ...
                            <fieldset id="domain">
                                ...
                                <div class="col-sm-3" style="float:right;">
                                    <div class="panel panel-default dvice_mode">
                                        ...
                                        <div class="panel-body">
                                            <input type="number" min="0" max="99" class="form-control list"
                                                name="num_pc_domain" id="num_pc_domain">
                                ...
                                <div class="col-sm-6" style="float:right;">
                                    <div class="panel panel-default dvice_mode">
                                        ...
                                        <div class="panel-body">
                                            <input type="text" class="form-control list" maxlength="50"
                                                name="note_not_domain" id="">
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" name="first_form" id="first_form"
                         formaction="misin_report.php"
                        >
