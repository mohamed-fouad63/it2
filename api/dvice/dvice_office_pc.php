...
$query_all_in_it = "SELECT num,id,office_name,dvice_type,dvice_name,sn,ip,pc_doman_name,note,note_move_to FROM dvice WHERE office_name = '".$input_search."' and id = 'pc' ";
