...
$count_in_it = $_GET['dvice_num'];
   include_once "../conn/conn.php";
$query_all_in_it = "SELECT dvice_name,sn,damage FROM in_it WHERE count_in_it = '$count_in_it' ";
$result = mysqli_query($conn, $query_all_in_it);


    while($row_pc=mysqli_fetch_assoc($result)){

            $pc_name_ticket1 = $row_pc['dvice_name'];
            $pc_sn_ticket = $row_pc['sn'];
            $pc_damage_ticket = $row_pc['damage'];
        }
...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/plugins/paper.css">
    <style>
        * {
            font-family: serif;
        }
...
<button type="button" class="btn_print" onclick="window.print();"> طباعه الماموريه </button>
    <div class="sheet padding-5mm">
        <div class="flex">
            ...
            <div><img class="post_logo" src="../assets/images/post.png" alt=""></div>
        </div>
        <hr>
        <div class="flex margin_top">
            ...
            <div><img class="post_logo" src="../assets/images/khtm.png" alt=""></div>
            <div>
        ...
        <div class="flex margin_top">
            ...
            <div><img src="../assets/images/hktm_cairo.png" alt=""></div>
        </div>
    </div>
</body>
