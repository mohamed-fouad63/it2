...
$reg_date =  date("Y-m-d");
 $query = "
 SELECT * FROM parcel_send  WHERE date = '$reg_date' and CHAR_LENGTH(barcode) = 13
 ";  
 ...
 <html lang="ar">  
    ...
    <script>
      ...
      <body>  
           <br /><br />  
           <div class="container">  
                <h4 align="center">حافظه ارسال طرود مصلحيه من الدعم الفنى بتاريخ  <?php echo $reg_date; ?></h4>
