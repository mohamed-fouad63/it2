...
<body>
                        ...
                        <fieldset class="mb-3" id="dvice_office_pos_field" style="/* display:none */">
                            <legend>
                                ...
                                <div class="btn-group mb-1 ms-1 float-end" role="group">
                                    ...
                                    <button type="button" class="btn btn-primary add_btn_deliver_pos"
                                        onclick="add_reg_to_sub()"><i class="bi bi-clipboard-plus"></i>
                                    </button>
                                    <button type="button" class="btn btn-warning reg_to_sub_del d-none"
                                        onclick="reg_sub_del()"><i class="bi bi-trash"></i>
                                    </button>
                                </div>
                            </legend>
    ...
    <div>
        ...
        include '../component/modals/dvices_in_it/edit_in_it_modal.html';
         } 
        if($_SESSION['to_tts'] == 1){
        include '../component/modals/dvices_in_it/to_tts_modal.php';
         }
        if($_SESSION['move_in_it'] == 1){
        include '../component/modals/dvices_office/move_to_modal.php';
         }
        if($_SESSION['resent_in_it'] == 1){
        include '../component/modals/dvices_in_it/resend_to_office_modal.php';
         }
        if($_SESSION['delete_in_it'] == 1){
        include '../component/modals/dvices_in_it/delete_modal.php';
         }
        if($_SESSION['retweet'] == 1){
        include '../component/modals/dvices_in_it/replace_pices_modal2.php';
         }
        if($_SESSION['retweet'] == 1){
        include '../component/modals/dvices_in_it/replace_pices_modal.php';
         }
        if($_SESSION['retweet'] == 1){
        include '../component/modals/dvices_in_it/replace_pices_modal3.php';
    } ?>
        <?php include '../component/modals/dvices_in_it/pos_deliver_report_modal.php';?>
    ...
    <script src="../data_tables/dvices_in_it.js"></script>
    <?php if($_SESSION['edit_in_it'] == 1){ ?>
    <script src="../js/dvices_in_it/edit_in_it.js"></script>
    <?php } ?>
    <?php if($_SESSION['to_tts'] == 1){ ?>
    <script src="../js/dvices_in_it/to_tts.js"></script>
    <?php } ?>
    <?php if($_SESSION['resent_in_it'] == 1){ ?>
    <script src="../js/dvices_in_it/resent_to_office.js"></script>
    <?php } ?>
    <?php if($_SESSION['delete_in_it'] == 1){ ?>
    <script src="../js/dvices_in_it/delete_in_it.js"></script>
    <?php } ?>
    <?php if($_SESSION['retweet'] == 1){ ?>
    <script src="../js/dvices_in_it/replace_pices1.js"></script>
    <script src="../js/dvices_in_it/replace_pices2.js"></script>
    <script src="../js/dvices_in_it/replace_pices3.js"></script>
    <script src="../js/upload/up.js"></script>
    <?php } ?>
    <?php if($_SESSION['move_in_it'] == 1){ ?>
    <script src="../js/dvices_in_it/move_to_in_it.js"></script>
    <?php } ?>
    ...
    <script>
        ...
        function pos_deliver_moda(){
            ...
            if(selectedData.length > 0 ){
                ...
                <td class="d-none"><?php echo $_SESSION['user_name']; ?><input type='hidden' name='names${key}[${k++}]' value='<?php echo $_SESSION['user_name']; ?>'></td>
    ...
    <script src="../js/dvices_in_it/deliver_pos_v200t.js"></script>
</body>
