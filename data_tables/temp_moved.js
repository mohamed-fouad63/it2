...
var dvice_office_pc = $("#dvice_office_pc").DataTable({
  ajax: {
    url: "/it2/api/dvice/temp_moved.php?dvice_id=pc",
    method: "get",
    dataSrc: "",
  },
  deferRender: true,
...
var dvice_office_monitor = $("#dvice_office_monitor").DataTable({
  ajax: {
    url: "/it2/api/dvice/temp_moved.php?dvice_id=monitor",
    method: "get",
    dataSrc: "",
  },
  deferRender: true,
...
var dvice_office_printer = $("#dvice_office_printer").DataTable({
  ajax: {
    url: "/it2/api/dvice/temp_moved.php?dvice_id=printer",
    method: "get",
    dataSrc: "",
  },
  deferRender: true,
...
var dvice_office_pos = $("#dvice_office_pos").DataTable({
  ajax: {
    url: "/it2/api/dvice/temp_moved.php?dvice_id=pos",
    method: "get",
    dataSrc: "",
  },
  deferRender: true,
...
var dvice_office_network = $("#dvice_office_network").DataTable({
  ajax: {
    url: "/it2/api/dvice/temp_moved.php?dvice_id=network",
    method: "get",
    dataSrc: "",
  },
  deferRender: true,
...
var dvice_office_postal = $("#dvice_office_postal").DataTable({
  ajax: {
    url: "/it2/api/dvice/temp_moved.php?dvice_id=postal",
    method: "get",
    dataSrc: "",
  },
  deferRender: true,
...
var dvice_office_other = $("#dvice_office_other").DataTable({
  ajax: {
    url: "/it2/api/dvice/temp_moved.php?dvice_id=other",
    method: "get",
    dataSrc: "",
  },
  deferRender: true,
