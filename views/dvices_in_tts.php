...
<body>
    ...
    <div>
        ...
        include '../component/modals/dvices_in_tts/edit_in_tts_modal.php';
        } ?>
        <!-- end edit modal -->
        <!-- start replace dvice modal -->
        <?php
        if($_SESSION['retweet'] == 1){
        include '../component/modals/dvices_in_tts/replace_pices_modal.php';
        include '../component/modals/dvices_in_tts/replace_pices_modal2.php';
         } ?>
        <!-- end replace dvice modal -->
        <!-- start resend dvice modal -->
        <?php
        if($_SESSION['resent_in_tts']){
        include '../component/modals/dvices_in_tts/resend_to_it_modal.php';
        } ?>
    ...
    <script src="../data_tables/dvices_in_tts.js"></script>
        <?php
        if($_SESSION['edit_in_tts']){ ?>
        <script src="../js/dvices_in_tts/edit_in_tts.js"></script>
        <?php } ?>
        <?php
        if($_SESSION['retweet'] == 1){ ?>
        <script src="../js/dvices_in_tts/replace_pices1.js"></script>
        <script src="../js/dvices_in_tts/replace_pices2.js"></script>
         <?php } ?>
        <?php
        if($_SESSION['resent_in_tts']){ ?>
        <script src="../js/dvices_in_tts/resent_to_it.js"></script>
        <?php } ?>
        <script>
