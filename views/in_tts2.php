...
<body>
    ...
    <div class="pcoded-main-container">
        <div class="pcoded-content" style="top:55px">
            <div id="main">
                        ...
                        <table id="pc_table" class="table align-middle table-hover">
                            ...
                            <tbody class="table-success">
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            <?php include '../component/in_tts_dropdown.html'?>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
    ...
    <div>
        <!-- start edit modal -->
            <?php include '../component/modals/edit_in_tts_modal.html'?>
        <!-- end edit modal -->
        <!-- start edit modal -->
