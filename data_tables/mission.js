var options_select_it_name = "<option value=''>اختر القائم بالمامويه</option>";
$.post(
  "../api/tbl_user/it_name.php",
  { x: "" },
  function (data) {
...
$.getJSON("../api/office/office_name.php?phrase", function (data) {
  $.each(data, function (key, val) {
    options_office_name +=
      "<option value='" +
      val.office_name +
...
var table = $("#example").DataTable({
  ...
  // stateSave: true,
  ajax: {
    url: "/it2/api/misin_it/mission.php",
    method: "post",
    data: {
      getid2: function () {
