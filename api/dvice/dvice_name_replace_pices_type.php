...
$id_replace_pices_type = $_GET['id_replace_pices_type'];
$query_all_in_it = "SELECT dvice_name FROM replace_pices_type WHERE id = '".$id_replace_pices_type ."' ORDER BY dvice_name ASC";
