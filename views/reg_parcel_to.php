...
session_login_auth('reg_parcel_to');
$db = $_SESSION['db'];
?>
<!DOCTYPE html>
<html lang="ar">
...
<body>
                        ...
                        <fieldset>
                            ...
                            <div id="reg_parcel_to_form">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="date" class="form-control col-sm-6  me-3" id="date_reg_parcel_to"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <textarea type="search" class="form-control col-sm-9" id="sub_reg_parcel_to"
                                        style="height: 110px;"></textarea>

                                </div>
                                <div class="mx-auto w-25">
                                    <button class="btn btn-primary" id="add_reg_parcel_to_btn"><i
                                            class="bi bi-plus"></i></button>
                                    <button class="btn btn-success" id="edit_reg_parcel_to_btn" style="display:none"
                                ...
                                <span class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <div class="d-flex">
                                            ...
                                            <button class="btn btn-success append_reg_parcel_to_sub ms-2"><i
                ...
                <table id="example" class="table table-hover align-middle">
                    <thead id="tablehead">
                        <tr>
                            ...
                            <th>الى</th>
                            <th>الموضوع</th>
                            <th><a href="../api/reg_parcel_to/reg_parcel_to_report.php" target="_blank" class=""><i
                                        class="btn btn-warning bi bi-printer" title="طباعه طرود صادر اليوم"></i></a>
                            </th>
                        </tr>
                    </thead>
                </table>
    ...
    <script src="../js/reg_parcel_to/remove_reg_parcel_to.js"></script>
    <script src="../js/reg_parcel_to/edit_reg_parcel_to.js"></script>
    <script src="../js/reg_parcel_to/append_reg_parcel_to_sub.js"></script>
    <script src="../js/reg_parcel_to/reg_sub_del.js"></script>
    <script src="../js/reg_parcel_to/add_reg_parcel_to_sub.js"></script>
    <script src="../js/reg_parcel_to/send_to_by_change.js"></script>
    <script src="../js/reg_parcel_to/easyAutocomplete.js"></script>
