...
<body>
    ...
    <script src="../data_tables/temp_moved.js"></script>
    <?php if($_SESSION['move'] == 1){ ?>
    <script src="../js/temp_moved/move_to.js"></script>
    <script src="../js/temp_moved/resent_to_office.js"></script>
    <?php } ?>
    <?php if($_SESSION['to_it'] == 1){ ?>
    <script src="../js/temp_moved/to_it.js"></script>
    <?php } ?>
</body>
