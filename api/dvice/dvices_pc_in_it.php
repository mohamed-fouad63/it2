...
$query_all_in_it = 'SELECT count_in_it,num,office_name,dvice_type,dvice_name,sn,damage,in_it_note,parcel_in_it,date_in_it FROM in_it WHERE status= "in_it" AND id = "'.$dvice_id.'"';
