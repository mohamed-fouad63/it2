...
(function(global, factory) {
        ...
        (function(window) {
            ...
            function matcherFromTokens(tokens) {
                var checkContext, matcher, j,
                    ...
                    matchContext = addCombinator(, implicitRelative, true),
                    matchAnyContext = addCombinator(, implicitRelative, true),
    ...
    jQuery.fn.extend({
        data: function(key, value) {
            ...
            return access(this, , null, value, arguments.length > 1, null, true);
        },
    ...
    jQuery.param = function(key, valueOrFunction) {
        ...
        ajax: function(url, options) {
            ...
            if (!transport) {
                ...
                if (s.async && s.timeout > 0) {
                    timeoutTimer = window.setTimeout(, s.timeout);
                }
    ...
    jQuery.each({
        ...
        jQuery.fn[method] = function(elem, method, val) {
    ...
    jQuery.each({
        ...
        jQuery.each({
            ...
            jQuery.fn[funcName] = function(elem, type, value) {
                var doc;
